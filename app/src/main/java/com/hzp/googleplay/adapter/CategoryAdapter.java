...
import com.hzp.googleplay.bean.SubCategory;
...
/**
 * created by hzp on 2019/6/26 22:56
 * 作者：codehan
 * 描述：
 */
    ...
    protected void bindViewHolder(Object obj, Object holder, int position) {
        ...
        switch (itemViewType) {
            ...
            case ITEM_SUB:
                ...
                ImageLoader.getInstance().displayImage( Url.IMG_PREFIX+subCategory.url1,subHolder.ivImage1, UILOption.options );
                ...
                if (!TextUtils.isEmpty(subCategory.name2)&&!TextUtils.isEmpty(subCategory.url2)){
                    ...
                    ImageLoader.getInstance().displayImage( Url.IMG_PREFIX+subCategory.url2,subHolder.ivImage2,UILOption.options );
                }else {
                    //说明需要隐藏第2个
                ...
                if(!TextUtils.isEmpty(subCategory.name3)&&!TextUtils.isEmpty(subCategory.url3)){
                    ...
                    ImageLoader.getInstance().displayImage( Url.IMG_PREFIX+subCategory.url3,subHolder.ivImage3,UILOption.options );
                }else {
                    //说明需要隐藏第3个
