...
/**
 * created by hzp on 2019/6/26 13:23
 * 作者：codehan
 * 描述：
 */
public class RandomLayout extends ViewGroup{
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        // 按照顺序存放把区域存放到集合中
        List<Integer> availAreas = new ArrayList<>( mAreaCount );
        ...
        for (int i = 0; i < count; i++) {
            ...
            if(child.getVisibility()==GONE){// gone掉的view是不参与布局
                continue;
            }
