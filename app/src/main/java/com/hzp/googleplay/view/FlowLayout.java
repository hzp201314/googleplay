...
/**
 * created by hzp on 2019/6/26 23:23
 * 作者：codehan
 * 描述：像水流一样的布局
 */
public class FlowLayout extends ViewGroup{
        ...
        for (int i = 0; i < lineList.size(); i++) {
            ...
            for (int j = 0; j < line.viewList.size(); j++) {
                ...
                if(isClearRemainSpace){
                    ...
                    view.setPadding( view.getPaddingLeft()+perSpace/2,view.getPaddingTop(),view.getPaddingRight()+perSpace/2,view.getPaddingBottom() );
                    //重新测量
                    view.measure( 0,0 );
                }
     ...
     * @return
     */
    private float getRemainSpace(Line line) {
