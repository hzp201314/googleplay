...
/**
 * created by hzp on 2019/6/26 14:47
 * 作者：codehan
 * 描述：
 */
public class AnimationUtil {
    ...
    /** 创建一个淡入放大的动画 */
    public static Animation creatPanInAnim(float degree){
        AnimationSet ret;
        Animation anim;
        ret=new AnimationSet( false );
        // 创建一个淡入动画
        ...
        ret.addAnimation( anim );
        // 创建一个放大动画
        final float pivoX=(float)(1-Math.cos( degree ))/2;
        final float pivoY=(float)(1+Math.sin( degree ))/2;

        anim=new ScaleAnimation( 0.8f,1,0.8f,1,Animation.RELATIVE_TO_SELF,pivoX,Animation.RELATIVE_TO_SELF,pivoY );
        anim.setDuration( MEDIUM );
        anim.setInterpolator( new DecelerateInterpolator(  ) );
        ret.addAnimation( anim );
    ...
    public static Animation createPanOutAnim(float degree){
        ...
        anim=new ScaleAnimation( 1,0.8f,1,0.8f,Animation.RELATIVE_TO_SELF,pivoX,Animation.RELATIVE_TO_SELF,pivoY );
        anim.setDuration( MEDIUM );
        anim.setInterpolator( new DecelerateInterpolator(  ) );
        ret.addAnimation( anim );
